<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminViewProductSales.aspx.cs" Inherits="MilkParlorSystem.AdminViewProductSales" %>
...
<div class="grid-form1">
        ...
        <div class="row">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Select Product"
                ControlToValidate="ddlProduct" InitialValue="--Select--" ForeColor="#FF3300" ValidationGroup="A"></asp:RequiredFieldValidator>
